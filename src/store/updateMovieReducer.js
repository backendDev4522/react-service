...
const UPDATE_MOIVE_VALIDATION_FAILED = 'UPDATE_MOIVE_VALIDATION_FAILED';

export const updateMovieValidationFailed = (error) => {
    return {
        type: UPDATE_MOIVE_VALIDATION_FAILED,
        payload: error,
    }
}
...
export default function updateMovieReducer(state = initailState, action) {
    switch (action.type) {
        case UPDATE_MOIVE_VALIDATION_FAILED:
